...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
            ...
            <Link href="/" className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground font-normal">
                  Sister Company of Tsion Alemayehu
                </p>
              </div>
            </Link>
          </motion.div>
      ...
      <section
        id="hero"
        className="pt-28 pb-12 px-6 bg-gradient-to-b from-card/50 to-background/50 backdrop-blur-sm"
      >
            ...
            >
              ...
              >
                <motion.p
                  ...
                  className="text-secondary text-sm font-semibold tracking-widest uppercase flex items-center gap-2"
                >
                ...
                >
                  Thak Trading One Member PLC specializes in the export of
                  premium spices and legumes, backed by the proven expertise of
                  our parent company, Tsion Alemayehu Import.
                </motion.p>
              </motion.div>
              <motion.div
      ...
      <section
        id="about"
        className="py-20 px-6 bg-background/50 backdrop-blur-sm"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
          ...
          >
            <motion.div className="space-y-4 max-w-2xl" variants={itemVariants}>
              ...
              <p className="text-muted-foreground text-lg">
                Building on decades of proven trading expertise, Thak Trading
                One Member PLC specializes in premium spices and legumes for
                global markets. We maintain the same quality standards and
                reliability that made our parent company a trusted industry
                leader.
              </p>
            </motion.div>
            ...
            >
              <motion.div
                className="space-y-4 bg-card p-8 rounded-lg border border-border"
                variants={scaleVariants}
                whileHover={{ scale: 1.02 }}
              >
                <h3 className="text-2xl font-bold">Our Mission</h3>
                <p className="text-muted-foreground">
                  To deliver the finest quality spices and legumes to discerning
                  businesses worldwide. We source directly from premium
                  Ethiopian organic farms and authentic local producers,
                  ensuring every product meets rigorous international standards.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Quality is non-negotiable. We work directly with verified
                  suppliers, maintain strict quality controls at every stage,
                  and ensure every shipment meets international food safety
                  regulations. Your trust is our foundation.
                </p>
              </motion.div>
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div className="space-y-2 max-w-2xl" variants={itemVariants}>
              ...
              <h2 className="text-4xl font-bold tracking-tight">
                Tsion Alemayehu Import
              </h2>
              <p className="text-muted-foreground text-lg pt-2">
                Our parent company with extensive experience serving global
                industries since its founding.
              </p>
            </motion.div>
              ...
              <motion.div className="space-y-6" variants={itemVariants}>
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Serving the Soap & Detergent industry with premium
                    ingredients:
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Importation of Tyre from China
                  </p>
                </div>
                <p className="text-xs text-muted-foreground pt-4 border-t border-border pt-6">
                  <span className="font-bold">Sourcing Regions:</span> China,
                  Indonesia, UAE
                </p>
              </motion.div>
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-4 flex-1">
                  ...
                  <p className="text-muted-foreground text-lg max-w-2xl">
                    Authentic, aromatic spices sourced from the finest growing
                    regions. Carefully selected and quality-tested for optimal
          ...
          >
            <motion.div className="space-y-4" variants={itemVariants}>
              <div className="flex items-start justify-between">
                <div className="space-y-4 flex-1">
                  <h2 className="text-4xl font-bold tracking-tight">
                    Quality Pulses & Legumes
                  </h2>
                  <p className="text-muted-foreground text-lg max-w-2xl">
                    Nutritious and versatile legumes perfect for food
                    production, restaurants, and retail. All products meet
      ...
      <section className="py-20 px-6 bg-background/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div className="space-y-4 max-w-2xl" variants={itemVariants}>
              <h2 className="text-4xl font-bold tracking-tight">
                Why Choose Thak Trading
              </h2>
              <p className="text-muted-foreground text-lg">
                Backed by decades of industry expertise and a commitment to
                excellence.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "Direct partnerships with trusted local suppliers in Ethiopia, ensuring authentic products.",
                },
                {
                  icon: "✓",
                  title: "Quality Assurance",
                  desc: "Rigorous testing at every stage. All products meet international food safety standards.",
                },
                {
                  icon: "🚚",
                  title: "Reliable Delivery",
                  desc: "Efficient logistics with seamless international shipping and documentation handling.",
                },
                {
                  icon: "💰",
                  title: "Competitive Pricing",
                  desc: "Premium quality at competitive prices through direct sourcing relationships.",
                },
                {
                  icon: "👥",
                  title: "Expert Support",
                  desc: "Knowledgeable team for product selection, bulk orders, and custom requirements.",
                },
                {
                  icon: "⚡",
                  title: "Flexibility",
                  desc: "Accommodate orders of any size with professional, reliable handling.",
                },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div className="space-y-4 max-w-2xl" variants={itemVariants}>
              ...
              <p className="text-muted-foreground text-lg">
                Ready to partner with us? We'd love to discuss your requirements
                and provide quotations for bulk orders.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    +251 9 8804 0588 / +251 9 8807 2630
                  </p>
                </div>
              </motion.a>
            ...
            <motion.div
              className="bg-background p-8 rounded-lg border border-border space-y-6"
              variants={itemVariants}
              whileInView="visible"
              initial="hidden"
            >
                ...
                <div className="py-2">
                  <ReCAPTCHA
                    ...
                    sitekey={
                      ...
                      "6LehxGUsAAAAAOuLSt7WCoUmnoby3BOd3Y23bE1c"
                    } // Fallback for dev only, user must update env
                    theme="light"
                  />
                </div>
          ...
          >
            ...
            <motion.div className="space-y-3" variants={itemVariants}>
              ...
              <ul className="text-sm text-muted-foreground space-y-2">
                ...
                <li>
                  <a href="#parent" className="hover:text-primary transition">
                    Tsion Alemayehu
                  </a>
                </li>
                <li>
            ...
            <motion.div className="space-y-3" variants={itemVariants}>
              ...
              <ul className="text-sm text-muted-foreground space-y-2">
                <li>
                  <a
                    href="mailto:Thaktrading@gmail.com"
